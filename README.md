...
<h3>CSP Model</h3>
<a href="https://ieeexplore.ieee.org/document/4408441/">Common Spatial Pattern (CSP)</a> algorithm decomposes the EEG signal such that it maximizes the difference in variance between two dichotomic classes (here low and high arousal) in EEG spatial filters.
