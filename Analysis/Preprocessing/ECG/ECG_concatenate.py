...
Author: Simon M. Hofmann | <[surname].[lastname][at]pm.me> | 2017
"""
...
#%% Function(s) >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o
...
if __name__ == "__main__":
    ...
    n_entries_df = np.zeros(shape=(nSub, len(phases)+1), dtype=np.int)
    # Matrix of all ECG-entries per phase per Subj.
    ...
    # Save n_entries_df
    np.savetxt(wdic + "concatenated/entries_per_phase_{}.csv".format(nSub), n_entries_df, fmt='%i',
               delimiter=";")
