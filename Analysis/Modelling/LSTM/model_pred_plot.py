    ...
    for subject in subjects:
        ...
        for midx, model in enumerate(models):
            ...
            if model == "LSTM":
                ...
                for _bin in [-1, 1]:
                    whole_rating_shift[whole_rating_shift == _bin] = _bin*(np.max(_bin*real_rating) + .1)
        ...
        # < o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >><< o >
            ...
            if model != "SPoC":  # LSTM, CSP:
                plt.title(label=f"{model} | " + r"$accuracy_{mean}=$" + f"{mean_acc:.3f}",
                ...
                plt.title(label=f"{model} | " + r"$r_{max}=$" + f"{r:.3f}",
                          fontdict={"fontsize": fs+2})
