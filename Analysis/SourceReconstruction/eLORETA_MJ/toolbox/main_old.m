...
locs_2D=mk_sensors_plane(eeg_sens,para); %make a variable locs_2D 
...
figure;plot_coherence(imag(cs),locs_2D);  %show the imaginary part of the cross-spectrum
...
figure;plot_coherence(cs,locs_2D,para); %plots 50 channels as 'head-in-head' with the above changes 
...
figure;plot_coherence(cs,locs_2D,para); %plots 30 channels as 'head-in-head' with the above changes 
