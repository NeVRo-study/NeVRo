function [s_all,vmax_all,imax_all,dips_mom_all,dips_loc_all]=SMusic_v1(patt,V,ns,grid,para);
...
% 
% usage: [s,vmax,imax,dip_mom,dip_loc]=SMusic_v1(patt,V,ns,grid,para);
%
% input: 
