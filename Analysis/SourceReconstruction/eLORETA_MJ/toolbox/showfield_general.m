...
% usage showfield_general(z,loc,pars); 
% displays fields/potentials specified by z 
% in channels at locations specified in locs as a contour-plot
%
% pars is optional
...
%  pars.cbar=1 draws colorbar, otherwiseno colorbar is shown. 
%              defaults is 1;
