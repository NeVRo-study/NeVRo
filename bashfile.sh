...
python3 NeVRo.py --subject 36 --lstm_size 150 --fc_n_hidden 100 --summaries False --plot True --path_specificities test_lstm-150_fc-100/
python3 NeVRo.py --subject 36 --lstm_size 150,100 --fc_n_hidden 100 --summaries False --plot True --path_specificities test_lstm-150-100_fc-150/
